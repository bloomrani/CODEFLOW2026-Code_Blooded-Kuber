...
class DashboardScreen extends StatelessWidget {
                    ...
                    return AnimatedContainer(
                      ...
                      child: Theme(
                        ...
                        child: ExpansionTile(
                          ...
                          // Splitting into Debits and Credits inside the dropdown
                          children: (() {
 ...
 List<PieChartSectionData> _buildPieChartSections(Map<String, dynamic> categories, Color dynamicTextColor) {
    ...
    // Absolute Maximum Contrast Palette.
  ...
  // --- FIX: WEB-COMPATIBLE PDF GENERATOR ---
  Future<void> _generateAndSharePDF(double income, double expense, double savings, String topSpend, String aiText, List<dynamic> txs, Map<String, dynamic> categories) async {
    ...
    // FIX: Generate the PDF into memory bytes instead of attempting to write to a non-existent web file path
    final bytes = await pdf.save();
    
    // Wrap the raw bytes into an XFile. Share_plus is smart enough to trigger a download on Chrome!
    final xFile = XFile.fromData(
      bytes,
      name: 'Kuber_AI_Report.pdf',
      mimeType: 'application/pdf',
    );
    
    await Share.shareXFiles(
      [xFile], 
      text: "Check out my AI Financial Report generated by Kuber!"
    );
  }
}
