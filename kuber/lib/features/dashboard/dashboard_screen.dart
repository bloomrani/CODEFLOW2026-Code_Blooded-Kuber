...
class DashboardScreen extends StatelessWidget {
  ...
  Future<void> _generateAndSharePDF(BuildContext flutterContext, double income, double expense, double savings, String topSpend, String aiText, List<dynamic> txs, Map<String, dynamic> categories) async {
    ...
    if (kIsWeb) {
      final xFile = XFile.fromData(bytes, name: 'Kuber_AI_Report.pdf', mimeType: 'application/pdf');
      await Share.shareXFiles([xFile], text: "Check out my AI Financial Report generated by Kuber!");
      ScaffoldMessenger.of(flutterContext).showSnackBar(const SnackBar(content: Text("PDF downloaded to your browser!")));
    } else {
